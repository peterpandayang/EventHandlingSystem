...
2.Enter the root and use maven to build the project: (/usr/local/Cellar/maven/3.5.2/bin/mvn clean compile package)<br />
3.Open one terminal and start the client: bash client.sh <br />
4.Open another terminal and start the server: bash server.sh <br />
5.Play with the system!<br />
